...
useEffect(()=>{
  ...
  <Route className="search-close" style={{alignSelf:"center" }} render={({history})=> <Search history={history}></Search>} />
   ...
   <Link to="/search-product" className="nav-div" style={{fontSize:"2.3rem", marginLeft:"1rem"}} >
     <span className="fa fa-search search-mini"></span>
      <span style={{fontSize:"1.4rem"}}> Search</span>
      </Link>

   <div className="nav-div" >   <Link   onClick={()=> setOpen(false)} className="float" to="/cart">
           {/* <span className="name"> Cart</span> */}
           <span  className="fa fa-shopping-cart"  style={{ fontSize:"2.3rem", color:"black" }} alt=""/>
         
           <span  className="cart-count" style={{background:"black", color:"white"}}>{cartItems.length}</span>
           <span style={{fontSize:"1.4rem", marginLeft:"-2.3rem", display:"block", color:"black"}}> Cart</span>
         </Link>
        
         </div>
   <div className="nav-div" > 
     <Link to="/wishlist">
           <span  style={{fontSize:"2.4rem", color:"black", marginRight:"3px"}} className=" fa fa-heart"></span>
           <span style={{fontWeight:"bold", color:"black"}}>{wishlistItems.length}</span>
         <span style={{fontSize:"1.4rem", display:"block"}}> Wishlist</span>
           ...
           <div className="nav-div chat-mobile">
             <span style={{fontSize:"2.8rem", color:"black"}} className="fas fa-comment-dots"></span>
...
<Link style={{color:"white", display:"inline"}} className="brand" to="/"> ChideStore</Link>
</div>
