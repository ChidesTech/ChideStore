...
<input type="search" name="search" style={{borderRadius:"12px",border:"1px solid blue"}} id="search" onChange={(e)=>setName(e.target.value)} placeholder="Search For Product . . ."/>
