...
const CategoryAddPage =(props)=>{
   ...
   return <>
          ...
          <div style={{display:"flex",justifyContent:"space-between" ,flexDirection:"row-reverse", marginTop:"1rem"}} >
              ...
              <Link to="category-list" style={{width:"40%",textAlign: "center", backgroundColor:"transparent", borderColor:"transparent", color:"steelblue", boxShadow:"1px 1px 1px 1px steelblue"}}  className="btn">Cancel</Link>
