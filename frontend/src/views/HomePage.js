...
const HomePage =(props)=>{
   ...
   dispatch(listProducts({pageNumber}))
    ...
    return(<ProjectSectionStyles>
        ...
        <h3 style={{textAlign:"center",fontSize:"3rem", marginBottom:"-10rem", marginTop:"7rem",color:"steelblue", textShadow:"1px 0 0 black"}}>SHOP WITH US</h3>
...
<h3>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed corporis quam magni, error eveniet eaque odit nesciunt numquam magnam nobis. Pariatur, maiores. Ratione corrupti ab vel consectetur excepturi accusantium placeat!</h3>  
        ...
        {/* <h3 style={{textAlign:"center",fontSize:"2rem", textTransform:"uppercase", marginTop:"-4rem",color:"steelblue", textShadow:"1px 0 0 black"}}>Browse By Categories</h3> */}
        {/* <h3 style={{textAlign:"center",fontSize:"3rem", marginBottom:"-6rem",color:"steelblue", textShadow:"1px 0 0 black"}}>Browse</h3> */}
...
{/* <h1 className="heading">  <span>Product</span> Gallery</h1> */}
      ...
      <h2 style={{textAlign:"center",fontSize:"3rem", marginTop:"7rem", color:"steelblue", textShadow:"1px 0 0 black"}}>Product Gallery </h2>
